...
namespace yidascanTest
{
    ...
    public class TestCase3
    {
        ...
        public void Init()
        {
            ...
            pinfo = new PanelInfo() { PanelNo = "2016090701", CurrFloor = 1, OddStatus = true, EvenStatus = false, Status = 0 };
            lcs = new List<LableCode>() {
                new LableCode() {LCode="A0001",ToLocation="B01",PanelNo="2016090701",Status=0,Floor=1,FloorIndex=7,Diameter=213,Coordinates="30,90,1153" },
                ...
                new LableCode() {LCode="A0007",ToLocation="B01",PanelNo="2016090701",Status=0,Floor=1,FloorIndex=5,Diameter=130,Coordinates="30,90,1023" }
            };
        }
        [NUnit.Framework.Test]
        public void Test()
        {
            LableCode lc = new LableCode() { LCode = "A0008", ToLocation = "B01", PanelNo = "2016090701", Status = 0, Floor = 1, FloorIndex = 0, Diameter = 142, Coordinates = "" };
            ...
            NUnit.Framework.Assert.AreEqual(lc2.LCode, "A0006");
            NUnit.Framework.Assert.AreEqual(lc2.FloorIndex, 8);
        }
    }
}
