    ...
    public class TestCase2
    {
        ...
        public void Init()
        {
            ...
            lcs = new List<LableCode>() {
                new LableCode() {LCode="A0001",ToLocation="B01",PanelNo="2016090701",Status=0,Floor=1,FloorIndex=0,Diameter=200,Coordinates="" },
        ...
        public void Test()
        {
            ...
            NUnit.Framework.Assert.AreEqual(lc2.FloorIndex, 5);
            NUnit.Framework.Assert.AreEqual(lc.FloorIndex, 7);
        }
    }
}
